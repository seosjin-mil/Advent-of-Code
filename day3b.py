string = """........................................................862...........20.............453...619......58........694...312.................292.
...
l = string.split('\n')
string_width = len(l[0])
string_height = len(l)

def number_location(y, x):
    start = x
    end = x

    while start > 0 and l[y][start - 1].isdigit():
        start = start - 1
    
    while end < string_width - 1 and l[y][end + 1].isdigit():
        end = end + 1    
    
    return (int(l[y][start: end + 1]), start, end)
        

def star_multiply(y, x):
    s = set()
    for i in range(y - 1, y + 2):
        for j in range(x - 1, x + 2):
            if i >= 0 and i < string_height and j >= 0 and j < string_width:
                print(l[i][j], end = "")
                if l[i][j].isdigit():
                    s.add(number_location(i, j))
        print()
...
while y < string_height:
    x = 0
    
    while x < string_width:
        if l[y][x] == '*':
            sum = sum + star_multiply(y, x)
        x = x + 1
    y = y + 1
